...
#
# Written by Phil Wilson, Februart 2011
...
class PhoneFinder
    ...
    def initialize
        @name = "Phonefinder Module"
        @commands = {'phone' => '$number - find out who an extension belongs to. Screen your calls!'}
        @times = Array.new
    end
    ...
    def findPerson(command)
        ...
        if id == nil then
            ...
            url = URI.parse("http://www.bath.ac.uk/contact/?prestrict=All&submit=Search&ptel="+URI.escape(id))
